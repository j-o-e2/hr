...
export default function NotificationsPage() {
  ...
  useEffect(() => {
    // Load tasks from localStorage and generate notifications
        ...
        try {
          ...
          tasks.forEach((task: any, index: number) => {
            if (task.dueDate) {
              ...
              // Check for newly assigned tasks (create notification if not already exists)
              ...
              if (!existingAssignmentNotif && task.assignedTo) {
                generatedNotifications.push({
                  ...
                  message: `${task.assignedTo} has been assigned to "${task.title}". Priority: ${task.priority}`,
                  timestamp: 'just now',
                  read: false,
              ...
              // Check for deadline reminders (within 3 days)
          ...
          // Remove duplicates and keep only the latest notifications
      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-medium text-muted-foreground">Task Assignments</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-medium text-muted-foreground">Deadline Alerts</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <CardContent>
              <div className="space-y-3">
                {notifications.map((notification) => (
                  <div
                    key={notification.id}
                    className={`p-4 border rounded-lg transition-colors ${getNotificationColor(notification.type, notification.read)}`}
                  >
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Get notified 2 days before deadline</p>
                </div>
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Alert for tasks past due date</p>
                </div>
                <input type="checkbox" defaultChecked className="w-4 h-4" />
              </div>
            </CardContent>
